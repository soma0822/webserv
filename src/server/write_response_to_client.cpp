...
WriteResponseToClient::WriteResponseToClient(int fd, HTTPResponse *response, HTTPRequest *request)
    : AIOTask(fd, POLLOUT), response_(response), request_(request),wrote_size_(0) {}

WriteResponseToClient::~WriteResponseToClient() { delete request_; delete response_; }
